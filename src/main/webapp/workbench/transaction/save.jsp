...
+ request.getContextPath() + "/";
    //从servletContext作用域中将pmap取出(pmap存放的是阶段与对应的可能性)
...
<body>
	...
	<form id="tranForm" action="workbench/transaction/save.do" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input name="coustomerName" type="text" class="form-control" id="create-customerName" placeholder="支持自动补全，输入客户不存在则新建">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="d64e4d2f2d334442961a9f5cb327280d" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="93e8c25a373648aca5f9269a9304b2f2" name="contactsId"/>
			</div>
		</div>
