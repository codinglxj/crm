...
<head>
    ...
    <script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    * */
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b>';
                        html += '<small style="color: gray;" id="b'+n.id+'"> ' + (n.editFlag == 0 ? n.createTime : n.editTime) + ' 由' + (n.editFlag == 0 ? n.createBy : n.editBy) + '</small>';
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
        ...
        function editRemark(id) {
            ...
            //将模态窗口中，隐藏域中的id进行赋值
            $("#remarkId").val(id);
            //不走后台，从前台页面获取noteContent的值赋值给文本框
            var content = $("#a" + id).html();
            //alert(content);
...
<div style="position: relative; top: -70px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 30px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${a.owner}&nbsp;&nbsp;</b>
